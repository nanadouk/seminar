...
In the following the cipher suite for key exchange and the authentication in \gls{tls} 1.2 are described.
...
The weak cryptographic algorithms have been deprecated, such that using static \gls{rsa} in the key exchange, gls\{rc} stream cipher, MD5 and SHA-1 hash functions. The compression of the plaintext before the applying of \gls{mac} is removed.
